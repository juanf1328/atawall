...
class App extends React.Component {
  ...
  <Col span={8}>
    <Input
      style={{
        width: '12rem',
        marginBottom: '1rem',  // Ajusta la separación vertical entre los inputs
...
<Row>
  <Col span={8}>
    <p style={{ color: '#05c988', textDecoration: 'underline', textDecorationColor: '#05c988', width: '7rem', cursor: 'pointer', marginLeft: '2rem' }}>{loginPage.needHelpText}</p>
  </Col>
</Row>
<Row>
  <Col span={8}>
